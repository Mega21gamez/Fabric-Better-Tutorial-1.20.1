package net.mega.tutorialmod.block;

import net.fabricmc.fabric.api.item.v1.FabricItemSettings;
import net.fabricmc.fabric.api.object.builder.v1.block.FabricBlockSettings;
import net.mega.tutorialmod.TutorialMod;
import net.mega.tutorialmod.block.custom.SoundBlock;
...
public class ModBlocks {
    ...
    public static final Block RUBY_BUTTON = registerBlock("ruby_button",
            new ButtonBlock(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK), BlockSetType.IRON, 10, true)); //wooden = arrow press
    ...
    //use a door/trapdoor OR add .nonOpaque()
